    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(db_index=True, help_text='Escribe un nombre para identificar al oficio', max_length=200, verbose_name='Nombre del oficio')),
                ('message', models.TextField(db_index=True, help_text='Acá podés contar detalladamente en qué consiste tu oficio, <b>cuanto mejor cuentes tu situación es más probable que te quieran ayudar</b>', max_length=2000, null=True, verbose_name='Descripción del oficio')),
                ('name', models.CharField(max_length=200, verbose_name='Nombre y Apellido de el/la responsable')),
                ...
                ('picture', models.ImageField(blank=True, help_text='Si querés podés adjuntar una foto relacionada con tu oficio, es opcional pero puede ayudar a que la gente entienda mejor tu situación', null=True, upload_to=core.utils.rename_img, verbose_name='Foto')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', models.CharField(help_text='Para ayudar a quien quiera ayudarte saber la dirección, ciudad, barrio, referencias, o cómo llegar', max_length=400, null=True, verbose_name='Dirección')),
                ('location', django.contrib.gis.db.models.fields.PointField(help_text='<p style="margin-bottom:5px;font-size:10px;">Seleccioná tu ubicación para que la gente pueda encontrarte, si no querés marcar tu casa una buena opción puede ser la comisaría más cercana o algún otro sitio público cercano.            <br>Si tenés problemas con este paso <a href="#" class="is-link modal-button" data-target="#myModal" aria-haspopup="true">mirá esta ayuda</a></p><p id="div_direccion" style="font-size: 10px; margin-bottom: 5px;"></p>', srid=4326, verbose_name='Ubicación')),
                ('picture', models.TextField(blank=True, help_text='Si querés podés adjuntar una foto relacionada con tu oficio, es opcional pero puede ayudar a que la gente entienda mejor tu situación', max_length=100, null=True, verbose_name='Foto')),
                ('resolved', models.BooleanField(db_index=True, default=False)),
                ('active', models.BooleanField(db_index=True, default=True)),
        ...
        migrations.CreateModel(
            name='OficioOwner',
            fields=[
                ('oficio', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='oficios.Oficio')),
