...
(function () {
  var GEO_URL = "/api/v1/oficiosgeo/";
  var LIST_URL = "/oficios/";
  var LIST_BY_CITY_URL = "/oficios_ciudad/";
  var TITLE = "Oficio";
  var ICON_URL = "/static/icons/marker-icon-2x-green.png";
  
  /**
   * ListOficiosView is the main component of the list.html page.
   *
   * @param {Object} map leaflet map instance
   */
  function ListOficiosView(map, options) {
    this.map = map;
  ...
  ListOficiosView.prototype.setupViewListeners = setupViewListeners;
  ...
  ListOficiosView.prototype.groupMarkerRequest = groupMarkerRequest;
  ListOficiosView.prototype.setupCitiesDropdown = setupCitiesDropdown;

  // export
  window.ListOficiosView = ListOficiosView;

  // implementation

  /**
   * ListOficiosView.setupViewListeners
   */
    ...
    var layerGroup = L.geoJSON(data, {
      onEachFeature: function (feature, layer) {
        var popup =
          ...
          '"><h1>'+ TITLE +' #' +
          feature.properties.pk +
          '</h1></a><p class="has-text-weight-bold">Olla Popular: ' +
